...
function PrimaryBtn({
  ...
  const base: React.CSSProperties = {
    ...
    padding: "14px 28px",
    background: disabled ? colors.gray300 : colors.purple,
    color: colors.white,
    border: "none",
    borderRadius: "12px",
    fontWeight: 700,
    ...
    boxShadow: disabled ? "none" : "0 4px 14px rgba(109,40,217,0.3)",
...
function ProgressBar({ current, total }: { current: number; total: number }) {
  ...
  return (
    <div style={{ margin: "12px 0" }}>
      ...
      <p style={{ fontSize: "13px", color: colors.gray500, marginTop: "4px" }}>
  ...
  return (
    <div>
      ...
      <div className="fade-in" style={{
        background: `linear-gradient(135deg, ${colors.purpleDark} 0%, ${colors.purple} 60%, #7C3AED 100%)`,
        color: colors.white,
        ...
        <h1 style={{
          ...
          Learning to read should feel like{" "}
          <span style={{ color: "#FCD34D" }}>winning</span>, not struggling.
        </h1>
        <p style={{
          fontSize: "20px",
          opacity: 0.9,
          ...
          NeuroRead builds a personalized reading plan for your child — built around
        ...
        <p style={{ marginTop: "20px", fontSize: "14px", opacity: 0.7 }}>
          No commitment. Cancel anytime. Price locked for early members.
        </p>
      </div>

      {/* Video */}
      <div style={{ background: colors.softYellow, padding: "56px 24px", textAlign: "center" }}>
        <p style={{ fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: colors.purple, marginBottom: "8px" }}>
          See it in action
        </p>
        <h2 style={{ fontFamily: font.display, fontSize: "28px", marginBottom: "28px" }}>
          Watch NeuroRead work
        </h2>
      ...
      <div style={{ padding: "64px 24px", maxWidth: "960px", margin: "0 auto" }}>
        <h2 style={{ fontFamily: font.display, fontSize: "32px", textAlign: "center", marginBottom: "40px" }}>
      ...
      <div style={{ background: colors.purpleLight, padding: "64px 24px", textAlign: "center" }}>
        <h2 style={{ fontFamily: font.display, fontSize: "32px", marginBottom: "12px" }}>
          Ready to see your child thrive?
        </h2>
        <p style={{ color: colors.gray700, marginBottom: "28px", fontSize: "18px" }}>
          Join families already using NeuroRead to build confidence one lesson at a time.
        </p>
        <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
          <PrimaryBtn onClick={onStart}>Try a Free Lesson</PrimaryBtn>
          <PrimaryBtn href={STRIPE_URL} style={{ background: colors.orange }}>
            Get Early Access — $29
          </PrimaryBtn>
        </div>
      </div>
      ...
      <footer style={{ background: colors.gray900, color: colors.gray300, padding: "32px 24px", textAlign: "center", fontSize: "14px" }}>
        <p style={{ fontFamily: font.display, color: colors.white, fontWeight: 700, fontSize: "18px", marginBottom: "8px" }}>
          Neuro<span style={{ color: colors.orange }}>Read</span>
        </p>
  ...
  const questions = [
    {
      ...
      tip: "This personalises every lesson for them.",
    },
    {
      key: "age",
      ...
      tip: "Lessons are matched to their age group.",
    },
    {
      key: "readingLevel",
      label: "How does reading feel for them right now?",
      type: "choice",
      choices: [
        "Very hard — they avoid reading",
        "Tricky — they try but struggle",
        "Okay — some words trip them up",
        "Pretty good — they just need a boost",
      ],
      tip: "No wrong answers — just helps us set the right pace.",
    },
    {
      key: "challenge",
      label: "What's their biggest challenge?",
      type: "choice",
      choices: [
        "Sounding out new words",
        "Understanding what they read",
        "Staying focused while reading",
        "Confidence — they feel like they can't do it",
      ],
    },
    {
      key: "goal",
      label: "What's the one thing you'd love them to feel in 4 weeks?",
      type: "choice",
      choices: [
        "Excited to pick up a book",
        "Proud of how far they've come",
        "Able to read on their own",
        "Less anxious about reading aloud",
      ],
    },
  ];
    ...
    <div style={{ minHeight: "100vh", background: colors.cream }}>
      ...
      <div style={{ maxWidth: "560px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div className="fade-in" key={step} style={{ marginTop: "32px" }}>
          <p style={{ fontSize: "13px", fontWeight: 700, color: colors.purple, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "8px" }}>
            Question {step + 1} of {questions.length}
          </p>
          <h2 style={{ fontFamily: font.display, fontSize: "26px", marginBottom: "8px" }}>
            {q.label}
          </h2>
              ...
              {q.choices!.map((c) => (
                <button
                  ...
                  style={{
                    padding: "14px 18px",
                    borderRadius: "12px",
                    border: `2px solid ${val === c ? colors.purple : colors.gray300}`,
                    background: val === c ? colors.purpleLight : colors.white,
                    color: val === c ? colors.purpleDark : colors.gray700,
                    fontFamily: font.body,
                    fontSize: "17px",
                    fontWeight: val === c ? 700 : 400,
                    textAlign: "left",
          ...
          <div style={{ marginTop: "32px", display: "flex", gap: "12px" }}>
            ...
            <PrimaryBtn onClick={next} disabled={!canContinue} style={{ flex: 1 }}>
...
function GeneratingScreen({ profile }: { profile: ChildProfile }) {
  const steps = [
    `Reading ${profile.name}'s answers…`,
    "Choosing the right reading level…",
    "Writing 5 personalised lessons…",
  ...
  return (
    <div style={{ minHeight: "100vh", background: colors.cream, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", textAlign: "center" }}>
      ...
      <h2 style={{ fontFamily: font.display, fontSize: "28px", marginBottom: "12px" }}>
        Building {profile.name}'s plan…
      </h2>
      <p className="pulse" style={{ color: colors.purple, fontWeight: 600, fontSize: "17px" }}>
        {steps[stepIdx]}
      </p>
    </div>
  );
    ...
    <div style={{ minHeight: "100vh", background: colors.cream }}>
      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div className="fade-in" style={{
          ...
          <h1 style={{ fontFamily: font.display, fontSize: "32px", marginBottom: "8px" }}>
            {profile.name}'s Reading Journey ⭐
          </h1>
          <p style={{ opacity: 0.85, fontSize: "16px" }}>
            This week's theme: <strong>{plan.weekTheme}</strong>
          </p>
          <div style={{ marginTop: "16px" }}>
            ...
            <p style={{ fontSize: "13px", opacity: 0.8, marginTop: "6px" }}>
              {completedLessons.length} of {plan.lessons.length} lessons complete
            </p>
          </div>
        </div>

        {/* Lessons */}
        <h2 style={{ fontFamily: font.display, fontSize: "22px", marginBottom: "16px" }}>
          This week's lessons
        </h2>
              ...
              <Card key={idx} style={{ border: isNext ? `2px solid ${colors.purple}` : `2px solid transparent`, opacity: done ? 0.7 : 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  <div style={{
                    ...
                    height: "48px",
                    borderRadius: "12px",
                    background: done ? colors.greenLight : isNext ? colors.purpleLight : colors.gray100,
                    display: "flex",
                    alignItems: "center",
                  ...
                  {(isNext || done) && (
                    <button
                      ...
                      style={{
                        padding: "8px 16px",
                        background: done ? colors.greenLight : colors.purple,
        ...
        <Card style={{ marginTop: "28px", background: colors.softYellow, border: `2px solid #FDE68A` }}>
          <p style={{ fontSize: "14px", fontWeight: 700, color: colors.orange, marginBottom: "4px" }}>
            💡 Parent tip
          </p>
          <p style={{ fontSize: "15px", color: colors.gray700 }}>
            Sit with {profile.name} for their first lesson this week. Hearing you read along builds confidence faster than anything else.
          </p>
        </Card>
      </div>
    </div>
...
function LessonScreen({
  ...
  return (
    <div style={{ minHeight: "100vh", background: colors.cream }}>
      <NavBar onBack={onBack} label={`Lesson ${lessonIdx + 1} of ${totalLessons}`} />
      <div style={{ maxWidth: "640px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        {stage === "read" && (
          <div className="fade-in">
            ...
            <h2 style={{ fontFamily: font.display, fontSize: "26px", marginBottom: "24px" }}>
              {lesson.title}
            </h2>
            <Card style={{ background: colors.softYellow, border: `2px solid #FDE68A`, marginBottom: "20px" }}>
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px" }}>
                ...
                <SpeakBtn text={lesson.passage} />
              </div>
            </Card>
            <Card style={{ marginBottom: "20px" }}>
              <p style={{ fontSize: "14px", fontWeight: 700, color: colors.orange, marginBottom: "4px" }}>✏️ Reading tip</p>
              <p style={{ fontSize: "15px", color: colors.gray700 }}>{lesson.tip}</p>
            </Card>
            <PrimaryBtn onClick={() => setStage("question")} style={{ width: "100%" }}>
        ...
        {stage === "question" && (
          <div className="fade-in">
            ...
            <p style={{ color: colors.gray700, marginBottom: "24px" }}>
              {lesson.question}
              <SpeakBtn text={lesson.question} />
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "24px" }}>
              {lesson.answers.map((a) => {
                ...
                if (selected) {
                  ...
                  bg = colors.purpleLight; border = colors.purple; color = colors.purpleDark;
                }
                return (
                  <button
                    key={a}
                    onClick={() => !selected && setSelected(a)}
                    style={{
                      padding: "14px 18px",
                      borderRadius: "12px",
                      ...
                      fontFamily: font.body,
                      fontSize: "17px",
                      fontWeight: isSelected || (selected && isCorrect) ? 700 : 400,
                      textAlign: "left",
                      transition: "all 0.15s",
                    }}
                  >
            ...
            {selected && (
              <div className="fade-in">
                <Card style={{ background: correct ? colors.greenLight : colors.softYellow, marginBottom: "20px" }}>
                  <p style={{ fontWeight: 700, color: correct ? colors.green : colors.orange, marginBottom: "4px" }}>
                    {correct ? "🌟 Brilliant!" : "💛 Not quite — that's okay!"}
                  </p>
                  <p style={{ fontSize: "15px", color: colors.gray700 }}>
                    {correct
                      ? "You understood the passage really well. Keep going — you're building something amazing!"
                      : `The answer was "${lesson.correct}". Reading it again can help — it gets easier every time.`}
                  </p>
                </Card>
                <PrimaryBtn onClick={() => setStage("done")} style={{ width: "100%" }}>
                  Finish lesson →
                </PrimaryBtn>
              </div>
            )}
        ...
        {stage === "done" && (
          <div className="fade-in" style={{ textAlign: "center" }}>
            ...
            <p style={{ color: colors.gray700, fontSize: "18px", marginBottom: "32px" }}>
              {correct
                ? "You nailed the comprehension check too. That's a double win!"
                : "You finished the lesson and gave it your best shot. That's what counts."}
            </p>
            <PrimaryBtn onClick={onComplete} style={{ width: "100%" }}>
              Back to my plan →
            </PrimaryBtn>
          </div>
        )}
  ...
  return (
    <div style={{ minHeight: "100vh", background: colors.cream }}>
      ...
      <div className="fade-in" style={{ maxWidth: "600px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: font.display, fontSize: "36px", marginBottom: "12px" }}>
          Welcome to NeuroRead!
        </h1>
        <div style={{ background: colors.greenLight, border: `2px solid ${colors.green}`, borderRadius: "12px", padding: "16px", marginBottom: "24px" }}>
          <p style={{ color: colors.green, fontWeight: 700 }}>
            ✅ Your early access spot is confirmed.
          </p>
        </div>
        <p style={{ color: colors.gray700, fontSize: "18px", marginBottom: "32px", lineHeight: 1.7 }}>
          You've unlocked full access to NeuroRead. Let's build your child's personalised reading plan — it only takes 2 minutes.
        </p>
        <PrimaryBtn onClick={onBegin} style={{ width: "100%" }}>
          Build my child's plan →
        </PrimaryBtn>
        <p style={{ marginTop: "16px", fontSize: "14px", color: colors.gray500 }}>
          Questions? Email us at hello@neuroread.ai — we reply to every message.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", background: colors.cream }}>
      ...
      <div className="fade-in" style={{ maxWidth: "560px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: font.display, fontSize: "32px", marginBottom: "12px" }}>
          Unlock full access
        </h1>
        <p style={{ color: colors.gray700, fontSize: "18px", marginBottom: "32px", lineHeight: 1.7 }}>
          You've just seen what NeuroRead can do. Unlock personalised weekly lesson plans, progress tracking, and unlimited reading sessions — built around your child.
        </p>

        <Card style={{ marginBottom: "24px", border: `2px solid ${colors.purple}` }}>
          <p style={{ fontSize: "13px", fontWeight: 700, color: colors.purple, marginBottom: "4px", textTransform: "uppercase", letterSpacing: "0.08em" }}>
            Early Access
          </p>
          <p style={{ fontFamily: font.display, fontSize: "48px", fontWeight: 800, color: colors.purpleDark }}>
            $29<span style={{ fontSize: "18px", color: colors.gray500 }}>/mo</span>
          </p>
          <p style={{ color: colors.gray500, fontSize: "14px", marginBottom: "20px" }}>
            Price locked for early members — never goes up.
          </p>
          {["Personalised AI lesson plan each week", "Dyslexia-friendly reading sessions", "Comprehension checks & instant feedback", "Read-aloud support on every word", "Progress tracking for parents", "Cancel anytime"].map((f) => (
            <p key={f} style={{ textAlign: "left", padding: "6px 0", fontSize: "15px", color: colors.gray700, borderBottom: `1px solid ${colors.gray100}` }}>
              ✓ {f}
            </p>
          ))}
        </Card>

        <PrimaryBtn href={STRIPE_URL} style={{ width: "100%", textAlign: "center" }}>
          Get Early Access — $29/mo →
        </PrimaryBtn>
        <p style={{ marginTop: "12px", fontSize: "14px", color: colors.gray500 }}>
...
export default function App() {
        ...
        lessons: [
          {
            ...
            passage: "Sam has a dog. The dog is big and brown. Sam and the dog play in the park every day.",
            tip: "Point to each word as you read it.",
            question: "Where do Sam and the dog play?",
            answers: ["In the park", "At school", "In the house"],
            correct: "In the park",
          },
          {
            day: "Day 2 — Tuesday",
            title: "A Rainy Morning",
            passage: "It rained this morning. Mia put on her red boots. She jumped in every puddle on the way to school.",
            tip: "Try reading it twice — the second time feels easier.",
            question: "What did Mia put on her feet?",
            answers: ["Her red boots", "Her socks", "Her shoes"],
            correct: "Her red boots",
          },
          {
            day: "Day 3 — Wednesday",
            title: "The Lost Kite",
            passage: "Ben flew his kite in the wind. The string got loose. The kite went up and up into the big blue sky.",
            tip: "Pause at every full stop. Let the words breathe.",
            question: "What happened to the kite string?",
            answers: ["It got loose", "It snapped", "It got longer"],
            correct: "It got loose",
          },
          {
            day: "Day 4 — Thursday",
            title: "Baking Cookies",
            passage: "Lily and her mum made cookies. They mixed flour, butter, and sugar. The kitchen smelled sweet and warm.",
            tip: "If a word is tricky, skip it and come back.",
            question: "How did the kitchen smell?",
            answers: ["Sweet and warm", "Cold and empty", "Smoky and dark"],
            correct: "Sweet and warm",
          },
          {
            day: "Day 5 — Friday",
            title: "My Superpower",
            passage: "Every reader starts somewhere. Each word you read makes your brain stronger. You are building your superpower right now.",
            tip: "Read this one out loud — you deserve to hear yourself do it.",
            question: "What are you building when you read?",
            answers: ["Your superpower", "A tower", "A story"],
            correct: "Your superpower",
          },
        ],
      });
      setScreen("dashboard");
  ...
  if (screen === "paywall") return <PaywallScreen onBack={() => setScreen("dashboard")} />;
